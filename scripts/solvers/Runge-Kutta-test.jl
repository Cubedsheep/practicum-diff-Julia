...
"""
function RK4diststest(f::Function, X0::Array{Float64, 1}, h::Float64, n1::Int64,
                    n2::Int64)
    # voeg de eerste 3 punten toe aan de array met punten
    X = [X0];
    push!(X, RK4_step(f, X[1], h));
    ...
    dist, t = dist_point_segment(X[1], X[2], X0)
    best = (dist, h*(n1+t-1))
